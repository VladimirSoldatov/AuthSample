...
var people = new List<Person>
{
    ...
    new Person("bob@gmail.com", "55555", "Ћондон", "Google"),
...
builder.Services.AddAuthorization(opts => {
    ...
    opts.AddPolicy("OnlyForLondon", policy => {
        policy.RequireClaim(ClaimTypes.Locality, "Ћондон", "London");
    });
